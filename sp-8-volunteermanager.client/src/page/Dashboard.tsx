  ...
  export const Dashboard: React.FC = () => {
    ...
    const adjustTabsForRole = (role: string) => {
      ...
      if (role === 'Admin') {
        // Tabs for admins
        const adminTabs = [...baseTabs, { name: 'Submissions', link: 'submissions' }, { name: 'Generate reports', link: 'reports' }, { name: 'Manage members', link: 'manage-members' }, { name: 'Invite', link: 'invite' }];
        setTabs(adminTabs);
      } else {
        setTabs(baseTabs);
      }
