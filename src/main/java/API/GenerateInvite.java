...
public class GenerateInvite implements HttpHandler {
    ...
    public void handle(HttpExchange t) throws IOException {
        ...
        if("GET".equalsIgnoreCase(method)) {
            ...
            String groupId = groupID; // Get the account ID part

            String inviteCode = ServerMain.d.newInviteCode(groupID);
            if(inviteCode == null) {
                String response = "Group not found "+groupId;
            ...
            jsonResponse.addProperty("invite_code", inviteCode);
