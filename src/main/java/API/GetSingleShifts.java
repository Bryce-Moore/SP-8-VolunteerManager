...
public class GetSingleShifts implements HttpHandler {
    ...
    public void handle(HttpExchange t) throws IOException {
        ...
        if ("GET".equalsIgnoreCase(method)) {
            ...
            String accountId = queryParams.get("account_id");
            if (groupId == null) {
            ...
            Vector<Shift> shifts = ServerMain.d.getSingleShifts(groupId,accountId);
            if (shifts.isEmpty()) {
