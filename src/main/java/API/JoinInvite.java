...
public class JoinInvite implements HttpHandler {
    ...
    public void handle(HttpExchange t) throws IOException {
        ...
        if(ServerMain.d.tokenValid(creds.auth_token)) { //only allow action is user is authorized
        	...
        	Session sess = ServerMain.d.cache.getSessionByToken(creds.auth_token);
				...
				try {
				//	System.out.println("USER ID IS: "+sess.getUser().getAccountID());
					
					ServerMain.d.joinByInvite(sess.getUser().getAccountID(),creds.invite_code);
